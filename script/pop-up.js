...
const modals = [{
  ...
  mobileImage: 'images/mobil.png',
  desktopImage: 'images/mobil.png',
  tech: ['html', 'css', 'javaScript'],
  details: ['Microverse', 'front End Dev', 2022],
  seeLive: 'https://abenezer-tilahun.github.io/MealApp/',
  seeSource: 'https://github.com/Abenezer-Tilahun/MealApp',
},
{
  title: 'Space Traveller Hub',
  text: "In this task, we worked with the real live data from the SpaceX API. The task was to build a web application for a company that provides commercial and scientific space travel services. The application will allow users to book rockets and join selected space missions.",
  mobileImage: 'images/space.png',
  desktopImage: 'images/dspace.png',
  tech: ['REACT', 'REDUX', 'CSS3'],
  details: ['CANOPY', 'Back End Dev', 2018],
  seeLive: 'https://aquamarine-concha-9215bd.netlify.app/',
  seeSource: 'https://github.com/keza681/space-travelers-hub',
},
{
  title: 'Facebook 360',
  text: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply dummy text of the printing and .",
